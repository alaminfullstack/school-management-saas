    ...
    <div class="flex">
        ...
        <aside id="sidebar" class="sidebar sidebar-mobile-hidden">
            ...
            <nav class="flex-1 overflow-y-auto custom-scrollbar p-3" id="menuNav">
                ...
                <a href="{{ route('teacher.dashboard') }}" data-title="Dashboard" data-link class="sidebar-item">
                ...
                <div class="sidebar-group">
                    <div class="sidebar-group-toggle">
                        <span><i class="fas fa-chalkboard-teacher w-4"></i> Teacher Section</span>
                        <i class="fas fa-chevron-right text-xs"></i>
                    </div>
                    <div class="sidebar-group-content">
                        <a href="{{ route('teacher.teacher.list') }}" data-title="Teacher List" data-link
                            class="sidebar-subitem">
                            <i class="fas fa-list"></i> Teacher List
                        </a>
                        <a href="{{ route('teacher.class.permission') }}" data-title="Class Permission" data-link
                            class="sidebar-subitem">
                            <i class="fas fa-user-check"></i> Class Permission
                        </a>
                        <a href="{{ route('teacher.assignment') }}" data-title="Assignment" data-link
                            class="sidebar-subitem">
                ...
                <div class="sidebar-group">
                    <div class="sidebar-group-toggle">
                        <span><i class="fas fa-users w-4"></i> Student Section</span>
                        <i class="fas fa-chevron-right text-xs"></i>
                    </div>
                    <div class="sidebar-group-content">
                        <a href="{{ route('teacher.student.list') }}" data-title="Student List" data-link
                            class="sidebar-subitem">
                            <i class="fas fa-list"></i> Student List
                        </a>
                        <a href="{{ route('teacher.class.time') }}" data-title="Class Time" data-link
                            class="sidebar-subitem">
